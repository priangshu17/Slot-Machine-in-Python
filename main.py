...
#function which checks the user inputed deposit
def deposit():
    while True:
...
#funtion which checks the user inputed number of lines
...
#funtion which checks the user inputed bet
def get_bet():
    while True:
...
def spin(balance):
    ...
    while True:
        ...
        if totalBet > balance:
            print(f"You don't have sufficient amount, your current balance is ${balance}.")
        else:
            break
